 ...
 *
 * @startuml if (Is the car silent when you turn the key?) then (yes)
...
public class App {
    public static void main(String[] args) {
        ...
        if (q1.equals("YES")) {
            ...
            String q2 = in.nextLine().toUpperCase();
            if (q2.equals("YES")) {
            ...
            String q3 = in.nextLine().toUpperCase();
            if (q3.equals("YES")) {
                System.out.println("Replace the battery.");
            } else {
                System.out.println("Does the car crank up but fail to start?");
                String q4 = in.nextLine().toUpperCase();
                if (q4.equals("YES")) {
                    System.out.println("Check spark plug connections");
                } else {
                    System.out.println("Does the engine start and then die?");
                    String q5 = in.nextLine().toUpperCase();
                    if (q5.equals("YES")) {
                        System.out.println("Does your care have fuel injection");
                        String q6 = in.nextLine().toUpperCase();
                        if (q6.equals("YES")) {
